...
// Identité de l'ensemble d'attributs OSM : 2022
    ...
    @Test
    void targetNodeIdWorksOnPositiveEdges() {
        ByteBuffer edgesBuffer = ByteBuffer.allocate(10);
// Sens : inversé. Nœud destination : 12.
        edgesBuffer.putInt(0, 12);
// Longueur : 0x10.b m (= 16.6875 m)
...
// Identité de l'ensemble d'attributs OSM : 2022
    ...
    @Test
    void targetNodeIdWorksOnNegativeEdges() {
        ByteBuffer edgesBuffer = ByteBuffer.allocate(10);
// Sens : inversé. Nœud destination : 12.
        edgesBuffer.putInt(0, ~12);
// Longueur : 0x10.b m (= 16.6875 m)
...
// Identité de l'ensemble d'attributs OSM : 2022
    ...
    @Test
    void isInvertedWorksOninverted(){
        ByteBuffer edgesBuffer = ByteBuffer.allocate(10);
// Sens : inversé. Nœud destination : 12.
        edgesBuffer.putInt(0, ~12);
// Longueur : 0x10.b m (= 16.6875 m)
...
// Identité de l'ensemble d'attributs OSM : 2022
    ...
    @Test
    void isInvertedWorksOnNotinverted(){
        ByteBuffer edgesBuffer = ByteBuffer.allocate(10);
// Sens : inversé. Nœud destination : 12.
        edgesBuffer.putInt(0, 12);
// Longueur : 0x10.b m (= 16.6875 m)
...
// Identité de l'ensemble d'attributs OSM : 2022
    ...
    @Test
    void length(){
        ByteBuffer edgesBuffer = ByteBuffer.allocate(21);
// Sens : inversé. Nœud destination : 12.
